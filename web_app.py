...
from web_service import WebPipelineService
...
def create_app(test_config: dict | None = None) -> Flask:
    ...
    app.config.from_mapping(
        SECRET_KEY=os.environ.get("WEB_APP_SECRET", "sabesp-relatorios-local"),
        OUTPUTS_ROOT=str(base_dir / "saidas"),
        MASTER_DIR=str(base_dir / "BASE_MESTRA"),
        HISTORY_FILE=str(base_dir / "data" / "processing_history.csv"),
        DRAFT_DIR=str(base_dir / "data" / "web_drafts"),
        NUCLEO_REFERENCE_FILE=str(base_dir / "config" / "nucleo_reference.json"),
    )
