...
from app.core.nucleo_master import get_nucleo_profile, load_nucleo_registry, reconcile_rows_with_registry
...
NUCLEO_REFERENCE_FILE = PROJECT_ROOT / "config" / "nucleo_reference.json"
