...
from nucleo_master import load_nucleo_registry, reconcile_rows_with_registry

CSV_NAMES = ["execucao", "ocorrencias", "frentes"]
NUCLEO_REFERENCE_FILE = Path(__file__).resolve().parent / "config" / "nucleo_reference.json"
KEYS = {
    "execucao": [
        "data_referencia",
        "contrato",
