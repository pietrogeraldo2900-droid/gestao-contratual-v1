...
class WebPipelineService:
    def __init__(
        ...
        self.history_file = Path(history_file) if history_file else self.base_dir / "data" / "processing_history.csv"
        self.draft_dir = Path(draft_dir) if draft_dir else self.base_dir / "data" / "web_drafts"
        self.unmapped_candidates_file = (Path(history_file).parent if history_file else self.base_dir / "data") / "unmapped_alias_candidates.csv"
